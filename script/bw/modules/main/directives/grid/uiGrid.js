                    ...
                    var UIGrid = (function () {
                        ...
                        UIGrid.prototype.addWidget = function (build, size, x, y) {
                            ...
                            var buildEl = [
                                ...
                                ' <div class="text-item start-date" style="height: ', this.subItemHeight, 'px; width:', this.widgetSize.width - 20, 'px; font-size: ', this.subItemHeight - 5, 'px"> ' + '<span> Start Date : </span> <span class="text"> ', build.startDate ? build.startDate.toLocaleString() : '', ' </span> ' + '</div>',
                                ' <div class="text-item finish-date" style="height: ', this.subItemHeight, 'px; width:', this.widgetSize.width - 20, 'px; font-size: ', this.subItemHeight - 5, 'px"> ' + '<span> Finish Date : </span> <span class="text"> ', build.finishDate ? build.finishDate.toLocaleString() : '', ' </span> ' + '</div>',
                                ' </div> ',
                                ' </li>'].join('');
